            ...
            <section className="section">
                <div className="box mb-5">
                    <div className="content">
                        ...
                        <p>
                            Snacky Trails is, at it's core, a mom and pop shop
                            just getting off the ground with a goal to serve
                            excellent food and experiences to our community.
                        </p>
                        <p>
                            Stephanie, the "mom" in our venture comes from a
                            nursing background, spening most of her professional
                            career in Seattle before moving down to Phoenix for
                            spicier food and weather.
                        </p>
                        <p>
                        ...
                        <p>
                            So why the food service industry? We both believe
                            that the best discussions to be had, connections to
                            be created, and memories to be cherished happen when
                            breaking bread with those you love.
                        </p>
                        <blockquote>
                            <p>
                                "The important thing is not being afraid to take
                                a chance. Remember, the greatest failure is to
                                not try. Once you find something you love to do,
                        ...
                        <p>
                            While neither of our background are in food service,
                ...
                <div className="box">
                    <div className="content">
                        ...
                        <div className="box has-background-primary-light mb-5">
                            ...
                            <p>
                                Keeping it real and doing the right thing, no
                                matter what.
                            </p>
                        </div>
                        <div className="box has-background-primary-light mb-5">
                            ...
                            <p>
                                Celebrating diversity and making sure everyone
                                feels at home.
                            </p>
                        </div>
                        <div className="box has-background-primary-light mb-5">
